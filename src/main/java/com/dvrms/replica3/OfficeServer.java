...
public class OfficeServer {
    ...
    private void initServerLogger() {
        try {
            ...
            // One file per office server: logs/R3-MTL-server.log, logs/R3-WPG-server.log, logs/R3-BNF-server.log
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (rr != null && rr.vehicleID.equals(vehicleID)) {
                    ...
                    // refund and fix remote-reservation count
    ...
    private String updateLocal(String customerID, String vehicleID,
        ...
        try {
            ...
            // Case 1: Update existing reservation
    ...
    private String cancelLocal(String customerID, String vehicleID, boolean adjustBudgetAtHome) {
        ...
        lock.lock();
        try {
            // 1) Try canceling an ACTIVE reservation
            ...
            if (rr != null) {
                ...
                // try assign next waitlisted user
                autoAssignWaitlist(vehicleID);
