...
public class RequestEnvelope {
    ...
    public RequestEnvelope(String msgId, int seqNum, String feHost, int fePort, String method, String[] args) {
        this.msgId = msgId;
        this.seqNum = seqNum;
        this.feHost = feHost;
        this.fePort = fePort;
    ...
    public String getTargetOffice() {
        switch (method) {
            ...
            case "updateReservation":
                return args[0].substring(0, 3); // customerID home office entry
            case "findVehicle":
            case "displayCurrentBudget":
            case "displayReservations":
            case "displayNotifications":
                return args[0].substring(0, 3); // customerID
            default:
